...
const config: SiteConfig = {
  ...
  socialLinks: {
    github: 'https://github.com/ZabouG',

    email: 'adrianguichard3@gmail.com',
    linkedin: 'www.linkedin.com/in/adrian-guichard',
